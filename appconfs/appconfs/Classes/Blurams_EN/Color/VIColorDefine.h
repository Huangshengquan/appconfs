...
#define color_common_base_custom                     @"#0CB9E2"          /// app基准色  禁用 alph .3f
#define color_common_label_text_selected             @"#0CB9E2"          /// 公共选中文本颜色
#define color_common_btn_globalsolid_bg_normal       @"#0CB9E2"          /// 公共实心按钮背景色（正常）（基准色）
#define color_common_btn_globalsolid_bg_disabled     @"#0CB9E2"          /// 公共实心按钮背景色（禁用）（基准色
#define color_common_btn_globalhollow_text_normal    @"#0CB9E2"          /// 公共空心按钮边框背景色（正常）（基准色）
...
///*-----------------------------------  登录注册模块（login） ----------------------------------- */
#define color_login_edit_account_normal             @"#FFFFFF"

#define color_login_label_secondary_text           @"#FFFFFF,#EEEEEE"
///登录页面“注册”，“忘记密码”文本颜色
#define color_login_label_white_text                 @"#FFFFFF,#EEEEEE"  /// 登录页面“HI，欢迎使用”，“地区选择”，“注册”，“忘记密码”文本颜色
#define color_login_edit_account_bg                  @"#333333,#191919"  /// 登录页面输入框背景颜色
...
#define color_player_label_bartitle_text             @"#0CB9E2,#FFFFFF"  /// 播放页底部bar文本颜色
